  ...
  policy = jsonencode({
    ...
    Statement = [
      ...
      },
      {
        ...
        Resource = "arn:aws:logs:*:*:log-group:/aws/lambda/${local.name_prefix}-analyze-sentiment:*"
      },
      {
        Effect = "Allow"
        Action = [
  ...
  policy = jsonencode({
    ...
    Statement = [
      ...
      },
      {
        ...
        Resource = "arn:aws:logs:*:*:log-group:/aws/lambda/${local.name_prefix}-batch-processor:*"
      },
      {
        Effect = "Allow"
        Action = [
  ...
  policy = jsonencode({
    ...
    Statement = [
      ...
      },
      {
        ...
        Resource = "arn:aws:logs:*:*:log-group:/aws/lambda/${local.name_prefix}-history:*"
      },
      {
        Effect = "Allow"
        Action = [
